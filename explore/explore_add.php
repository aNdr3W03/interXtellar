...
<head>
    ...
    <title>interXtellar - Add Exploration</title>
</head>
...
<body>
    ...
    <div class="container mt-5 mb-5">
        <div class="card">
            <div class="card-header bg-dark text-white">Add Exploration</div>
            <div class="card-body">
                <form method="POST" action="explore_insert.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="star" id="star" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="mass" class="col-sm-2">Mass</label>
                        <div class="col-sm-10">
                            <input type="text" name="mass" id="mass" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="travel_time" id="travel_time" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button class="btn btn-success col-3" type="submit">Add Exploration</button>
                        </div>
                    </div>
                </form>
            </div>
